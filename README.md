...
- Microsoft 365 prerequisites: [`docs/M365_SETUP.md`](docs/M365_SETUP.md) · Email for IT: [`docs/IT_REQUEST_EMAIL.md`](docs/IT_REQUEST_EMAIL.md) · Demo: [`docs/DEMO.md`](docs/DEMO.md) · Google SSO: [`docs/GOOGLE_SSO_SETUP.md`](docs/GOOGLE_SSO_SETUP.md) · CSV import: [`docs/CSV_IMPORT.md`](docs/CSV_IMPORT.md)
