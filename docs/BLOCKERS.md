...
- **Still open:** Google provider needs the OAuth client id/secret from IT (email Part 4) → Supabase → Authentication → Providers → Google. Until then students cannot sign in (teachers/admins can).
