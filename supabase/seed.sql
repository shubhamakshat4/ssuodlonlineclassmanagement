...
values
  ('a0000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"admin","must_change_password":false}', '{"full_name":"Priya Raghavan"}', now(), now(), '', '', '', '', false, false),
  ...
  ('b0000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"teacher","must_change_password":false}', '{"full_name":"Dr. Anand Mishra"}', now(), now(), '', '', '', '', false, false),
  ('b0000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"teacher","must_change_password":false}', '{"full_name":"Prof. Kavita Sen"}', now(), now(), '', '', '', '', false, false),
  ('b0000000-0000-4000-8000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"teacher","must_change_password":true}', '{"full_name":"Dr. Rohit Verma"}', now(), now(), '', '', '', '', false, false),
  ...
  ('c0000000-0000-4000-8000-000000000001', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Aarav Sharma"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000002', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Diya Patel"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000003', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Ishaan Rao"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000004', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Meera Nair"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000005', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Kabir Malhotra"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000006', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Sneha Iyer"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000007', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Rahul Das"}', now(), now(), '', '', '', '', false, false),
  ('c0000000-0000-4000-8000-000000000008', '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated',
   ...
   '{"provider":"email","providers":["email"],"provisioned_by":"seed","role":"student"}', '{"full_name":"Ananya Ghosh"}', now(), now(), '', '', '', '', false, false);
